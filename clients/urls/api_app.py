...
urlpatterns = [
    ...
    path("api/app/leads/<int:lead_id>/documents/", app_api.app_lead_documents, name="app_lead_documents"),
    path("api/app/leads/<int:lead_id>/documents/delete/", app_api.app_lead_document_delete,
