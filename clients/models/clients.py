...
class Renewal(models.Model):
    ...
    # The Insurance Tracker policy this renewal is against. Set when the user
    # picks an existing policy on the add-renewal screen, or when a new policy
    # is created from the renewal. Lets a policy show its full renewal history.
    policy = models.ForeignKey("InsurancePolicy", null=True, blank=True,
